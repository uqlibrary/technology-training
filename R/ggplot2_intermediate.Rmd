...
* Case sensitive
* No spaces in names
* You can use Ctrl + Shift to space out your code and Ctrl + Enter to run a command.
...
Closing RStudio will ask you if you want to save your project.
