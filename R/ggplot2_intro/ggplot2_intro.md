...
> This document is redacted in Rmd; the source file is available here: <https://github.com/stragu/CDS/blob/master/R/ggplot2_intro/ggplot2_intro.Rmd> It is then knitted as a GitHub document, which is the best version to view online and to print: <https://github.com/stragu/CDS/blob/master/R/ggplot2_intro/ggplot2_intro.md>
...
![](ggplot2_intro_files/figure-markdown_github/unnamed-chunk-4-1.png)
...
![](ggplot2_intro_files/figure-markdown_github/unnamed-chunk-6-1.png)
...
Let's use the `diamonds` dataset now. The `diamonds` dataset comes in ggplot2 and contains information about ~54,000 diamonds, including the price, carat, color, clarity, and cut of each diamond.
