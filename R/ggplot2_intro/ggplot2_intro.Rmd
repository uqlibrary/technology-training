---
title: "R data visualisation with RStudio and ggplot2: an introduction"
...
> It is then knitted as a GitHub document, which is the best version to view online and to print: https://gitlab.com/stragu/DSH/blob/master/R/ggplot2_intro/ggplot2_intro.md
...
1. the variable `conservation` is mapped to the aesthetic `x`;
