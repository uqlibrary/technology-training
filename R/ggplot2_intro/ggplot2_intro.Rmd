...
> This document is redacted in R markdown; the source file is available here: https://gitlab.com/stragu/DSH/blob/master/R/ggplot2_intro/ggplot2_intro.Rmd
...
For a horizontal bar chart, we can map the `cut` variable to the `y` aesthetic instead of `x`:
