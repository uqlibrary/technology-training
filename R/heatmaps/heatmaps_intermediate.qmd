...
{{< embed heatmaps_intermediate_banner.qmd >}}
...
> [Installation instructions](../installation.qmd) are available if you don't have R and RStudio installed already.
...
-   More heatmap packages:
    ...
    - [**tidyheatmaps**](https://jbengler.github.io/tidyheatmaps/), built on pheatmap but for tidy data
...
-   Our [compilation of R resources](../usefullinks.qmd)
