...
Our date comes from the Bureau of Meteorology website. You can get the archive here: https://cloudstor.aarnet.edu.au/plus/s/svECiZfnH5uUrWX
...
Now, let's make sure we have the data ready to be used in our app. We don't want to do the merging of our data every time we run the app, so let's save the finished product into an RDS file:
