...
The values are reported in Mt CO~2~-e.
```
...
We can now include a visualisation using, for example, ggplot2:
...
We also have a general [list of recommended R resources](../usefullinks.qmd).
