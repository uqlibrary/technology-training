...
{{< embed tidyverse_next_steps_banner.qmd >}}

## Setting up

> If needed, review the [installation instructions](../installation.qmd).
...
* [Chapter on iteration](https://r4ds.hadley.nz/iteration.html) in the book _R for Data Science_
* Cheatsheets:
...
* Explore our [recommended resources, online and around UQ](../usefullinks.qmd)
