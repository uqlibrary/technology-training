...
> If needed, review the [installation instructions](https://gitlab.com/stragu/DSH/blob/master/R/Installation.md).
...
Lets try a different type of output. Here, we want to find out which columns in the starwards dataset are of type "character":
