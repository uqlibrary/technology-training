...
<!--
Note for maintainers: the two following chunks are not executed when rendering 
the document, to avoid repeatedly (and slowly) downloading data from BOM.
If the data needs updating, first run the two following chunks locally to 
update the data. Then render.
-->
