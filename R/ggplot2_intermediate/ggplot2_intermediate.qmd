...
To add yet another variable to the visualisation, we can animate the plot but associating the `frame` aesthetic with the `year` variable. This adds a slider and a "Play" button under the visualisation.
