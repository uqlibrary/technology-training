...
You can now identify single points, zoom into your plot, and show/hide categories. However, the popup does not tell us which country the point corresponds to. That's because we don't mention the `country` variable in our code. Let's reveal that information by slightly modifying the `p` object:
