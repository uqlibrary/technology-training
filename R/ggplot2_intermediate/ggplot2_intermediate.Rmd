...
We'll first create a new project to keep everything nicely contained in one directory:
...
Try other pre-built themes, like `theme_bw()` and `theme_classic()`. You can also start with an empty theme thanks to `theme_void()`, and even install extras with the package `ggthemes`.
