# uMap: create quick interactive maps
UQ Library
2024-09-16
...
Now go back to “Manage layers” (there a left arrow at the top of the
...
To go further, one can define a template to use data from the table, for
