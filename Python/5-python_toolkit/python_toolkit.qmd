...
# 🚧🚧🚧 Software changes incoming 🚧🚧🚧

We have decided to shift from the Spyder IDE to [Positron](https://positron.posit.co/).

Positron looks and feels like VS Code with the data science features of RStudio and Spyder. 

These materials still refer to Spyder, and are subject to change over the next few months. The Python content will remain unchanged.
