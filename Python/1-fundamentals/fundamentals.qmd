...
> The help information can often be dense and difficult to read at first, taking some practice. In the [next session](../2-data_processing/data_processing.qmd) we look closer at interpreting this **documentation**, one of the most important Python skills.
