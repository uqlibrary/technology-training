...
- Create a new script with <kbd>ctrl</kbd>+<kbd>N</kbd>, `File > New file...` or the new file button ![new file symbol](fundamentals_files/new_file.png) .

You should now see a script on the left panel in Spyder, looking something like this:

![Example of a new script](fundamentals_files/new_script.png)
...
![Example of a console input](fundamentals_files/new_script.png)

We'll work out of a script for the rest of the session. Don't forget to save your script by pressing <kbd>ctrl</kbd>+<kbd>S</kbd> or the save button ![save file symbol](fundamentals_files/save_file.png).
