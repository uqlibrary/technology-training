...
* Anthropics shares articles about their work on their [Research](https://www.anthropic.com/research) page, which includes some work on how models are trained. News outlets report on what is learned from the outside, for example on Anthropic's moving from first [using pirated copies of copyrighted works](https://www.washingtonpost.com/technology/2025/09/05/anthropic-book-authors-copyright-settlement/) to [digitising and destroying physical books they purchase](https://www.theguardian.com/commentisfree/2026/aug/05/anthropic-ai-destroying-books) (also known as "destructive scanning").
* On ethics, Anthropic has a "Constitution" that includes a collection of "Principles" based on various sources (Universal Declaration of Human Rights, Apple, DeepMind, their own research, and targeted at "encouraging consideration of non-Western perspectives").
* 
