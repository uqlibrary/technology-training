...
{{< embed QGIS_intro_banner.qmd >}}

## Setting up

This tutorial is designed for **QGIS 3.44**, the "Long-Term Release" (LTR) at the time of writing.

If you need to install it:

* On your own computer: install the software from the [QGIS website](https://qgis.org/download/)
* On ITS-managed computers: install from Company Portal (Windows) or Self Service (macOS)
* On Library computers: install from ZENworks

::: {.callout-tip}

We recommend using the LTR rather than the latest release as it is expected to be more stable, but feel free to use a more recent version if you find their new features useful.

See the [release schedule](https://qgis.org/resources/roadmap/#schedule) to know when a version becomes the LTR, and the [visual changelogs](https://qgis.org/project/visual-changelogs/) to find out about new features in the latest release.
