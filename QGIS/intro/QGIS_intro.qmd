...
This tutorial is designed for **QGIS 3.40**. If you need to install it on your computer, got to the [QGIS website](https://qgis.org/en/site/forusers/download.html).
...
-   Navigate to where you want to save your project, and create a new folder, let's call it "qgis_mobile".
...
-   Finally, let's save our .qgz project file inside the "qgis_mobile" folder, named "qgis_mobile_map.qgz"
