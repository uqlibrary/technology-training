...
-   In you internet browser, navigate to [colorbrewer2.org](https://colorbrewer2.org/#type=qualitative&scheme=Set2&n=7)
...
-   Click the new **Simple Fill**
    ...
    -   Scroll to the bottom, tick `Draw Effects`, then click the ![](images/mIconPaintEffects.png) `Customise effects` button (The one next to "Enable symbol layer", _not_ the one in the "Layer Rendering" section!)
        -   Untick `Source`
